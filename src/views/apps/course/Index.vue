            ...
            <div class="datatable invoice-table">
                <div class="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                    <div class="flex items-center gap-2">
                        <router-link to="/apps/courses/add" class="btn btn-primary gap-2">
                            <svg
                ...
                >
                    ...
                    <template #actions="data">
                        <div class="flex justify-end gap-x-2">
                            <router-link :to="{ name: 'course-edit', params: { id: data.value.id } }">
...
<script lang="ts" setup>
    ...
    import { useGetCourses } from './actions/getCourses';
    ...
    const cols = ref([
        ...
        { field: 'name', title: 'Nombres', width: '25%' },
        { field: 'description', title: 'Descripción', width: '20%' },
        { field: 'start_date', title: 'Fecha de Inicio', width: '15%' },
        { field: 'end_date', title: 'Fecha de Término', width: '20%' },
