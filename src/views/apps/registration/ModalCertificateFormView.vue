                                ...
                                <div class="flex flex-row justify-center items-end container px-5">
                                    <div class="flex flex-col w-full">
                                        ...
                                        <div class="flex w-full">
                                            <input type="file" id="customTemplate_file" accept=".pdf" class="form-input" @change="onFileChanged" />
                                            <div class="flex">
                                        ...
                                        <template v-if="isSubmitForm && $v4.form.certificate_file.$error">
                                            <p class="text-danger mt-1">Por favor suba un certificado en formato .pdf</p>
                                        </template>
                                    </div>
                                </div>
                            </form>
