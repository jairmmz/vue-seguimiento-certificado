...
const routes: RouteRecordRaw[] = [
    ...
    {
        path: '/apps/surveys/index',
        name: 'survey-index',
        meta: { requiresAuth: true },
        component: () => import('../views/apps/survey/Index.vue'),
    },
    {
        path: '/apps/surveys/add',
        name: 'survey-add',
        meta: { requiresAuth: true },
        component: () => import('../views/apps/survey/Add.vue'),
    },
    {
        path: '/apps/surveys/edit/:id',
        name: 'survey-edit',
        meta: { requiresAuth: true },
        component: () => import('../views/apps/survey/Add.vue'),
    },
    {
        path: '/apps/surveys/config/:id',
        name: 'survey-config',
        meta: { requiresAuth: true },
        component: () => import('../views/apps/survey/group-questions/Index.vue'),
    },
    {
